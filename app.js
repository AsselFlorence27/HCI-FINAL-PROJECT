...
const products = [
  // Aerox Engine Parts
  {
    ...
    category: "engine",
    price: 4500,
    image: "/polini-intake-manifold.jpg",
    description:
  ...
  },
  {
    ...
    category: "engine",
    price: 7500,
    image: "/dellorto-carburetor-phva.jpg",
    description:
  ...
  // Aerox Suspension Parts
  {
    ...
    category: "suspension",
    price: 8500,
    image: "/yss-front-shock-adjustable.jpg",
  ...
  },
  {
    ...
    category: "suspension",
    price: 5800,
    image: "/brembo-rear-shock-spring.jpg",
  ...
  // Aerox Brakes
  {
    ...
    category: "brakes",
    price: 3200,
    image: "/brembo-sintered-brake-pads.jpg",
  ...
  },
  {
    ...
    category: "brakes",
    price: 3800,
    image: "/wave-brake-rotor-disc-220mm.jpg",
  ...
  // Aerox Body Parts
  {
    ...
    category: "body",
    price: 5500,
    image: "/puig-racing-windshield-smoke.jpg",
  ...
  },
  {
    ...
    category: "body",
    price: 7200,
    image: "/carbon-fiber-side-mirrors.jpg",
  ...
  // Aerox Electrical Parts
  {
    ...
    category: "electrical",
    price: 6800,
    image: "/stage6-ignition-coil.jpg",
  ...
  },
  {
    ...
    category: "engine",
    price: 8200,
    image: "/mikuni-carburetor-vm24.jpg",
  ...
  },
  {
    ...
    category: "engine",
    price: 12000,
    image: "/polini-exhaust-system.jpg",
  ...
  },
  {
    ...
    category: "suspension",
    price: 10500,
    image: "/yss-rear-shock-adjustable.jpg",
  ...
  },
  {
    ...
    category: "brakes",
    price: 4200,
    image: "/stainless-brake-lines.jpg",
  ...
  // Nmax Body Parts
  {
    ...
    category: "body",
    price: 6800,
    image: "/led-taillight-cluster.jpg",
  ...
  },
  {
    ...
    category: "body",
    price: 9800,
    image: "/street-racer-fairing-set.jpg",
            ...
            <div class="product-detail-info">
                ...
                <div>
                    ...
                    <ul style="list-style: none; margin-bottom: 2rem;">
                        ${product.specs.map((spec) => `<li style="margin-bottom: 0.5rem; color: var(--text-light);">✓ ${spec}</li>`).join("")}
                    </ul>
                </div>
...
function calculateCartTotals() {
  ...
  const tax = subtotal * 0.12 // Updated tax rate for PHP
...
function updateCartTotals(subtotal, tax, total) {
  ...
  document.getElementById("tax").textContent = `₱${tax.toLocaleString("en-PH")}`
...
function updateCheckoutSummary() {
  ...
  document.getElementById("checkoutSubtotal").textContent = `₱${subtotal.toLocaleString("en-PH")}`
  document.getElementById("checkoutTax").textContent = `₱${tax.toLocaleString("en-PH")}`
...
function handleCheckoutSubmit(e) {
  ...
  const orderData = {
    ...
    items: cart.length,
    total: (cart.reduce((sum, item) => sum + item.price * item.quantity, 0) * 1.12).toFixed(2), // Updated tax rate for PHP
  }
